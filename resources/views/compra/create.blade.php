        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    <div class="panel-heading">Crear Nueva compra</div>
                    <div class="panel-body">
                        ...
                        {!! Form::open(['url' => '/compra', 'class' => 'form-horizontal', 'files' => true]) !!}

                                    <div class="form-group {{ $errors->has('cant_producto') ? 'has-error' : ''}}">
                {!! Form::label('cant_producto', 'Cantidad Producto', ['class' => 'col-md-4 control-label']) !!}
                <div class="col-md-6">
